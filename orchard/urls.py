...
admin.site.site_header = "Orchard Capitals Administration"
admin.site.site_title = "Orchard Capitals Admin Portal"
admin.site.index_title = "Welcome to Orchard Capitals Admin Portal"
...
urlpatterns = [
    ...
    path('api/auth/copy-trader/active/', copy_trader_active, name='copy-trader-active'),
