...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='Citadel Markets Pro <support@orchardcapitals.com>')
ADMIN_NOTIFICATION_EMAIL = config('ADMIN_NOTIFICATION_EMAIL', default='support@orchardcapitals.com')
...
MIDDLEWARE = [
    ...
    'orchard.middleware.AppendSlashMiddleware',
...
# Use manifest storage only in production; in dev, serve files directly
if DEBUG:
